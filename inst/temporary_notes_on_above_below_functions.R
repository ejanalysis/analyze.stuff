...
# how many cols are above cutpoint gives one summary answer per row, so its analogous to rowMins not colMins.
...
#  RESOLVE WHICH PARAMETERS TO USE IN cols... count... rows... pct...  -- cutpoints, benchmarks, of.what
# what did of.what even do?

# allow parameter benchmarks or cutpoints to be a vector of cutpoints as long as relevant dim
# (i.e., allow a different row-specific cutpoint for each row, or 1 per col)
