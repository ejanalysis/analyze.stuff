...
#'
#' rbind(blah, min=colMins(blah), max=colMaxsapply(blah))
#'
...
#' rbind(blah, min=colMins(blah), max=colMaxsapply(blah), mean=colMeans(blah, na.rm=TRUE), sum=colSums(blah, na.rm=TRUE))
#' @export
