#' @title Overlay two simple histograms
...
#' @example  
#'   \dontrun{
#'   pdf2(log10(bg$proximity.npl), bg$bin.EJ.DISPARITY.proximity.npl.eo, 10, main ='npl for high top 10 pct vs low EJ', xlab='NPL score log10')
#'   } 
#' @export
