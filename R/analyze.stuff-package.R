...
#'
#'  **Acknowledgements: \cr
#'   The package \link{sp} function \code{\link[sp]{spDists}}. The \link{matrixStats} package provides versions of rowMins, rowMax, colMins, colMaxs and related functions.
